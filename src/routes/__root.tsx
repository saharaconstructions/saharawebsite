...
// Replace with your real GA4 Measurement ID from analytics.google.com
const GA_MEASUREMENT_ID = "G-QCQ70Y5050";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium construction company in Maharashtra. Residential, commercial, RCC, interiors, waterproofing & more. Quality, Service, Trust." },
      { name: "author", content: "Sahara Constructions" },
      { name: "theme-color", content: "#1a2e6b" },
      { name: "apple-mobile-web-app-title", content: "Sahara Constructions" },
